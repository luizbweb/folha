			...
			<header class="page-header">
				<h1 class="page-title">
					<?php
						...
						elseif ( is_day() ) :
							printf( __( 'Dia: %s', 'profitmag' ), '<span>' . get_the_date() . '</span>' );

						elseif ( is_month() ) :
							printf( __( 'Mês: %s', 'profitmag' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'profitmag' ) ) . '</span>' );

						elseif ( is_year() ) :
							printf( __( 'Ano: %s', 'profitmag' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'profitmag' ) ) . '</span>' );
